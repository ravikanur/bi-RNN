...
LOCAL_DATA_DIRS = CONFIG_DATA["local_data_dirs"]
...
TRAINING_OUTPUT_DIM_SIZE = TRAINING_PARAMS["OUTPUT_DIM_SIZE"]
ENCODER_PATH = LOCAL_DATA_DIRS["ENCODER_PATH"]
TRAIN_DS_PATH = LOCAL_DATA_DIRS["TRAIN_DS_PATH"]
TEST_DS_PATH = LOCAL_DATA_DIRS["TEST_DS_PATH"]
